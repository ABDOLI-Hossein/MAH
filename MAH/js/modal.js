(function ($){
    $.fn.saModal = function (userOptions){
        var options = $.extend({
            ...
            width: 768,             // width of modal in pixel
        ...
        modalButtons.each(function (){
            window.mBtn = $(this);
            window.mBox = $("."+mBtn.attr("data-modal")).css({width: options.width + "px"});
            mBtn.on(options.showEvent,function (e){
                ...
                if(options.showCloseButton === true){
                    mBox.append($("<div class='closebtn'>").append("<svg style='max-width: 70%;' height=\"48\" viewBox=\"0 0 48 48\" width=\"48\" xmlns=\"http://www.w3.org/2000/svg\"><path fill='#fff' d=\"M38 12.83l-2.83-2.83-11.17 11.17-11.17-11.17-2.83 2.83 11.17 11.17-11.17 11.17 2.83 2.83 11.17-11.17 11.17 11.17 2.83-2.83-11.17-11.17z\"/><path d=\"M0 0h48v48h-48z\" fill=\"none\"/></svg>"))
